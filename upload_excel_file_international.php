            ...
            <div class="row ">
                <div class="col-sm-8 complete_profile" style="text-align: left !important;">
                    <?php if (isset($customer_data['is_order_manual']) and $customer_data['is_order_manual'] == 1) { ?>
                        <a class="go_to sample_sheet" href="<?php echo BASE_URL ?>sample/internation_booking_manual.xlsx" download><?php echo getLange('downloadsamplesheet'); ?></a>
                    <?php } else { ?>
                        <a class="go_to sample_sheet" href="sample/internation_booking.xlsx" download><?php echo getLange('downloadsamplesheet'); ?></a>
                    <?php } ?>
...
<script>
    $(document).ready(function() {
        $("#submit").click(function() {
            ...
            $.ajax({
                url: 'ajax_bulk_import_international.php',
                dataType: 'Json',
                beforeSend: function() {
                    $('#image1').show();
                },
