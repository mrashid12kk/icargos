...
var jexcel = (function(el, options) {
    ...
    obj.enterKey = function(mixed, rowNumber, insertBefore) {
        obj.options.onenterkey();
    }
    /**
     * Insert a new row
     * 
    ...
    if (jexcel.current) {
        if (jexcel.current.edition) {
            if (e.which == 27) {
                ...
                // console.log(jexcel.current.options.data[0]); return false;
            //     var data = jexcel.current.options.data[0];
            //     var hasEmpty = false;
            ...
            // }
            // console.log("kam thk ho rea?"); return false;
                // Enter
                    ...
                    if (jexcel.current.options.allowInsertRow == true) {
                        if (jexcel.current.options.allowManualInsertRow == true) {
                            if (jexcel.current.selectedCell[1] == jexcel.current.options.data.length - 1) {
                                ...
                                // jexcel.current.insertRow(); //Custom Update
                            }
                        }
                    }
                    jexcel.current.down();
