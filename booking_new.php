            ...
            <div class="col-lg-10 col-md-9 col-sm-8 dashboard">
                ...
                <div class=" shipper_box" style="padding: 10px 0;">
                    ...
                    <form role="form" action="booking.php" method="POST" id="booking_form_new">
                        ...
                        <input type="hidden" name="" class="booking_type" value="international">
                                                       ...
                                                       <div class="col-sm-3 ">
                                                        ...
                                                        <div class="col-sm-3 padd_left padd_right">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="myNumber" name="cweight" id="charweight" class="form-control cweight"  required="true" value="1">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3 padd_left padd_right">
                                                            <div class="form-group">
                                                                <label class="calculation_label"><span style="color: red;">*</span> Scale weight</label>
                                                                <input type="myNumber" name="sweight" class="form-control"  required="true" value="1">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 padd_left padd_right">
                                                            <div class="form-group">
                                                                <label class="calculation_label"><span style="color: red;">*</span> Dimensional weight</label>
                                                                <input type="myNumber" name="weight" class="form-control weight"  required="true" value="1">
                                                            </div>
                                                        </div>
                                                         <div class="col-sm-3 padd_left">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label class="control-label"><span style="color: red;"></span>
                City</label>
                <input type="text" class="form-control add_areas_booking" placeholder="City">
            </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var selected = '';
                                ...
                                service_types_options += '<option '+selected+' value="' + service_types[i]
                                .id +
                                '">';
