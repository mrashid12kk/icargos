                ...
                <div class="full_row">
                    ...
                    <div class="col_2 input_fix">
                        ...
                        <?php
                            ...
                            ?>
                        <input type="text"
                            value="<?php echo isset($zone['description']) && $zone['description'] != '' ? $zone['description'] : '';; ?>"
                            readonly>
            ...
            <div class="main_address main_address_3">
                <div class="full_row">
                    <div class="col_6 left_box align_content">
                        ...
                        <div class="dot_line">
                            <b>Validity :</b>
                            <p><span><?php echo isset($fetch['validity']) ? date('d-m-Y', strtotime($fetch['validity'])) : ''; ?></span>
                            </p>
                        </div>
                        <div class="dot_line">
                        ...
                        <div class="dot_line">
                            <b>Bank Name :</b>
                            <p><span><?php echo isset($fetch['bank_name']) ? $fetch['bank_name'] : ''; ?></span>
                            </p>
                        </div>
                        <div class="dot_line">
                            <b>Account No. :</b>
                            <p><span><?php echo isset($fetch['bank_ac_no']) ? $fetch['bank_ac_no'] : ''; ?></span>
                            </p>
                        </div>
                    </div>
                    <div class="col_6 right_box align_content_right">
                        ...
                        <div class="dot_line">
                            <b>Branch Name :</b>
                            <p><span><?php echo isset($fetch['branch_name']) ? $fetch['branch_name'] : ''; ?></span>
                            </p>
                        </div>
                        <div class="dot_line">
                            <b>Account Title :</b>
                            <p><span><?php echo isset($fetch['acc_title']) ? $fetch['acc_title'] : ''; ?></span>
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <?php $customerViseQ = "SELECT * From customer_tariff_detail WHERE customer_id=" . $_GET['account_no'];
                ...
                $num_row = mysqli_num_rows($productMainQ);
                if ($num_row > 0) {
                ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <!-- <?php echo $end_range; ?> -->
                                    <?php if (isset($end_range) && $end_range == '    99999.9') {
                                                        echo 'Additional 0.5Kg';
                                                    } else {
                                                        echo $end_range;
                                                    } ?>
                                </td>
