                ...
                <div class="col-sm-10 table-responsive" id="setting_box">
                    <?php
                        ...
                        if (isset($_GET['delete_id'])) {
                            $id = $_GET['delete_id'];
                            $query1 = mysqli_query($con, "DELETE from pincode where id=$id") or die(mysqli_error($con));
                            $rowscount = mysqli_affected_rows($con);
                            if ($rowscount > 0) {
                                echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>' . getLange('Well_done') . '!</strong>You delete a Pincode Successfully</div>';
                            } else {
                                echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">X</button><strong>' . getLange('unsuccessful') . '!</strong>Ypu cannot delete Pincode unsuccessfully.</div>';
                            }
                        }
                        ...
                        $city = mysqli_query($con, "SELECT * from cities order by id desc");
                        if (isset($_GET['edit_id']) && $_GET['edit_id'] != '') {
                            $edit = mysqli_fetch_assoc(mysqli_query($con, "SELECT * from pincode WHERE id=" . $_GET['edit_id']));
                        }
                        ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">Pincode</div>
                        <div class="panel-body" id="same_form_layout">
                            
                            <form role="form" data-toggle="validator" action="pincode.php<?php echo isset($_GET['edit_id']) ? '?edit_id='.$_GET['edit_id'] : ''; ?>" method="post"  enctype="multipart/form-data">
                                <div id="cities">
                                    ...
                                    <div class="row" id="select_citites">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="pincode" value="<?php echo isset($edit['pincode']) ? $edit['pincode'] : ''; ?>" required>
                                                <div class="help-block with-errors "></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 rtl_full">
                                            <button type="submit" name="<?php if (isset($edit)) {echo 'update_pincode';} else {echo 'add_pincode';} ?>" class="add_form_btn"><?php echo getLange('submit'); ?></button>
                                        </div>
                                    </div>
                                </div>
                                <br>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Pincode
                        ...
                        <div class="panel-body" id="same_form_layout" style="padding: 11px;">
                            <div id="basic-datatable_wrapper"
                                ...
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        <?php
                                            $query1 = mysqli_query($con, "SELECT country.country_name,cities.city_name,country.image,state.state_name,cities.city_name,pincode.id,pincode.pincode FROM pincode LEFT JOIN country on pincode.country_id=country.id LEFT JOIN state on pincode.state_id=state.id LEFT JOIN cities on pincode.city_id=cities.id ORDER BY id desc");
                                            $sr = 1;
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td class="sorting_1"><?php echo $fetch1['pincode']; ?></td>
                                            <td class="center">
                                                <a href="pincode.php?edit_id=<?php echo $fetch1['id']; ?>">
                                                    <span class="glyphicon glyphicon-edit"></span>
                                                </a>
                                                <a href="pincode.php?delete_id=<?php echo $fetch1['id']; ?>"
