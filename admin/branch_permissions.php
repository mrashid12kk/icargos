<?php
  ...
  if(isset($_POST['save_changes'])){
    ...
    foreach ($_POST['module_id'] as $key => $value) {
        ...
        if(isset($_GET['role_id'])){
            ...
            $role_query = mysqli_query($con,"SELECT * FROM branch_permissions WHERE role_id=".$existing_role_id." AND module_id=".$value." ");
        ...
        if (isset($role_data)) {
           ...
           $updateQuery = "UPDATE `branch_permissions` SET `view_id`='$view',`add_id`='$add',`edit_id`='$edit',`delete_id`='$delete',`approve_id`='$approve',`print_id`='$print',`import_id`='$import',`export_id`='$export' WHERE role_id = '$role_data_id' AND module_id= '$value' ";
            ...
            $addQuery = "INSERT INTO `branch_permissions`(`role_id`,`module_id`, `view_id`, `add_id`, `edit_id`, `delete_id`, `approve_id`, `print_id`, `import_id`, `export_id`) VALUES ('$role_id','$value','$view','$add','$edit','$delete','$approve','$print','$import','$export')";
    ...
    header("location:branch_permission.php?role_id=".$_GET['role_id']);
  ...
  $roles = mysqli_query($con,"SELECT * FROM branches");



  $permissions = mysqli_query($con,"SELECT * FROM branch_permission");
       ...
       <style type="text/css">
        ...
        <div class="warper container-fluid">
            ...
            <div class="page-header">
             ...
             <form method="POST" action="#">
              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-heading"><?php echo getLange('branchpermission'); ?> </div>
                ...
                <div class="panel-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-4 colums_gapp">
                            ...
                            <select class="form-control active_customer_detail js-example-basic-single"  onchange="window.location.href='branch_permission.php?role_id='+this.value">

                                <?php foreach($roles as $role){ ?>

                                <option  <?php if(isset($_GET['id']) && $_GET['id'] == $role['id']){ echo "Selected"; } ?> value="<?php echo $role['id']; ?>"><?php echo $role['name']; ?></option>
           ...
           <div class="submit_btn">
                ...
                <button type="submit" name="save_permissions"><?php echo getLange('save'); ?></button>
