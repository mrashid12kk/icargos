...
if (isset($_SESSION['users_id']) && ($_SESSION['type'] !== 'driver')) {
	...
	if (!checkRolePermission($_SESSION['user_role_id'], 11, 'view_only', $comment = null)) {
    ...
    <section class="content">
        ...
        <div class="warper container-fluid">
            ...
            <?php
				...
				include "pages/orders/delivery_run_sheet.php";
        ...
        $('body').on('change', '.deliveryZone', function(e) {
            e.preventDefault();
            let value = $(this).val();
            console.log(value);
            $('.cls_delivery_zone').val(value);
        })
        </script>
