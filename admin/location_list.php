        ...
        <div class="warper container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 " id="setting_box">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="panel panel-primary">
                                <div class="panel-heading add_new_btn">
                                    Location List <a href="add_country.php" class="btn btn-info">Add New</a>
                                </div>
                    ...
                    ?>
                                    <div class="col-sm-12 table_template">
            ...
            <!--  <?php
              ...
              // include "pages/location/location_list.php";
