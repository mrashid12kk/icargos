...
<body data-ng-app>
	...
	?>
        ...
        <div class="warper container-fluid">
			...
			include "pages/orders/pickup_order_processing.php";
	...
	//delivery run barcode
 	$('.status_update_run_for_rider').on('keyup change', function (e) {
		...
		if(keycode == '13'){
             ...
             users_id = "<?php echo $_SESSION['users_id']; ?>";
			$.ajax({
				type:'POST',
				data:{ tracking_status:1,order_ids:order_ids,rider_for: 'pickup',users_id:users_id },
				url:'ajax.php',
				dataType:'JSON',
