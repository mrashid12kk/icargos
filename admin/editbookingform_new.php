...
$('body').on('click', '.btn_commercial_invoice', function(e) {
    ...
    e.preventDefault();
    var html =
        "<div class='row'><div class='col-sm-6 sidegap'><div class='form-group'><label class='calculation_label'>Description</label><input type='text' class='form-control' name='c_i_discription[" +
    array_value +
    ...
    array_value +
    "]' class='form-control' value='PK'></div></div><div class='col-sm-1 sidegap'><div class='form-group'><label class='calculation_label'>HS Code</label><input value='0' type='text' name='c_i_hs_code[" +
    array_value +
    ...
    array_value +
    "]' value='0' class='form-control c_i_hs_total'></div></div><div class='col-sm-2 sidegap'><div class='form-group'><label class='calculation_label'>Length</label><input type='text' name='c_i_hs_length[" +
    array_value +
