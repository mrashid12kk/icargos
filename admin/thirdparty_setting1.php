                        ...
                        <div class="container">
                            ...
                            <div class="col-xs-3">
                                <ul class="nav nav-tabs tabs-left">
                                    <li class="active"><a href="#ClientInfo" data-toggle="tab">SONIC</a></li>
                                    <li><a href="#tab2" data-toggle="tab">General </a></li>
                                    <li><a href="#tab3" data-toggle="tab">Service Mapping</a></li>
                                    <li><a href="#tab4" data-toggle="tab">Status Mapping</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="ClientInfo">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">Add Api </div>
                                        ...
                                        <div class="panel panel-primary" style="margin-top: 5px">
                                            <div class="panel-heading">Api's List </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">City Mapping </div>
                                            <div class="panel-body">
                                                <form method="post" action="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label>Api</label>
                                                            <select class="form-control" name="api_id" required="">
                                                                <option value="">Select</option>
                                                                <?php
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="form-control api_city_id" name="api_city_id"
                                                                ...
                                                                {
                                                                    ?>
                                                                <option data-cityname="<?php echo $cityvalue->name; ?>"
                                                                    value="<?php echo $cityvalue->id; ?>">
                                        ...
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">Status Mapping </div>
                                            <div class="panel-body">
                                                <form method="post" action="">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">Service Mapping</div>
                                            <div class="panel-body">
                                                <form method="post" action="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="submit"
                                                                class="btn btn-info btn_style pull-right"
                                                                name="save_service_map" value="Save" />
                                                        </div>
                                                    </div>
                                                </form>
                                                        ...
                                                        <table class="table table-stripped table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo getSonicModeName($row->api_service_id) ?>
                                                                    </td>
                                                                    <td><a onclick="return confirm('Are you sure you want to delete?');"
                                                ...
                                                <form method="post" action="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="submit"
                                                                class="btn btn-info btn_style pull-right"
                                                                name="save_status_map" value="Save" />
                                                        </div>
                                                    </div>
                                                </form>
                                                    <?PHP 
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Third Party Setting</h4>
                    </div>
        ...
        <div id="deleteModel" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Delete Third Party Setting</h4>
                    </div>
                    <div class="modal-body">
