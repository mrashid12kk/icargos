<div class="col-sm-12 outer_shadow table_template">
   <div class="top_heading">
      <h3 class="">Filters</h3>
      <!-- <a href="single_sms.php" class="btn btn-info" style="margin-top: -60px;margin-left: 785px;">Add New</a> -->
   </div>
   ...
   <md-table-container>
      <table id="sms_table" class="ng-pristine ng-untouched ng-valid md-table ng-isolate-scope ng-not-empty table-bordered" >
         ...
         <thead class="">
            <tr md-row="" class="">
               <th class=""><span class="">Sr No.</span></th>
               <th class=""><span class="">Receiver Phone</span></th>
               <th class=""><span class="">Message</span></th>
               <th class=""><span class="">Sent To</span></th>
            ...
            <tr class="md-row">
               ...
               <th class=""><input autocomplete="off" type="text" class="" id="customer">
               </th>
               <th class="">
                  <input autocomplete="off" type="text" class="datetimepicker4 hidden" id="datetime" >
               </th>
               <th class="">
               </th>
               <th class="">
