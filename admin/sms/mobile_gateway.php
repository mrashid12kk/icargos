...
if(isset($_POST['submit']))
{
    ...
    $res=mysqli_query($con,"SELECT * FROM sms_settings WHERE id=1") or die(mysqli_error($con));
    if(mysqli_num_rows($res) >= 1)
    {
        mysqli_query($con,"UPDATE `sms_settings` SET `api_name_web`='".$api_name_web."',`api_key_web`='".$api_key_web."',`api_url_web`='".$api_url_web."',`device_id`=".$device_id.",`sim_slot`=".$sim_slot." WHERE id=1") or die(mysqli_error($con));
    ...
    header("Location: admin/mobile_gateway.php");
}
...
<div class="col-sm-12 outer_shadow">
	...
	<form action="mobile_gateway.php" method="POST">
		<div class="row">
