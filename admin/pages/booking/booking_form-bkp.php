                                            ...
                                            <div class="col-sm-4 padd_left">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="<?php echo $row['city_name']; ?>" <?php if ($row['city_name'] == $customer_city) {
                                                                        echo "selected";
                                                                    } ?>>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6 padd_left padd_right">
                                                <div class="form-group">
                                                    <label class="control-label"><span style="color: red;">*</span>
                                                        <?php echo getLange('destination'); ?></label>
                                                    <select
                                        ...
                                        <div class="panel panel-default" style="padding-bottom: 0;">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 width_33 padd_left padd_right">
                                                        <div class="form-group">
