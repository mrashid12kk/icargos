                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="<?php echo $row['origin_area_id'] ?>"
                                                            <?php if (isset($row2['origin_area_id']) && $row2['origin_area_id'] == $row['id']) {  } ?>><?php echo $row['area_name']; ?></option>
                                                        <?php } ?>>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="panel-body">
						                         ...
						                         fuel_surcharge" required="true">
                                                        ...
                                                        <?php if ($admin_other_charges == '1') : ?>
                                                            ...
                                                            class="col-sm-12  input_label_box main-box-x total_charged">
                                                            <?php else: ?>
                                                                <div style="clear: both;"
