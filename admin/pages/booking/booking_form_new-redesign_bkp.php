                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 sidegap" >
                                        ...
                                        <div class="col-sm-1 sidegap" >
                                            ...
                                            <div class="col-sm-5 sidegap" style="display: none;">
                                                    <div class="form-group">
                                                        <label
                                                ...
                                                <div class="col-sm-2 sidegap">
                                                    ...
                                                    <div class="col-sm-2 sidegap">
                                                        ...
                                                        <div class="col-sm-2 sidegap">
                                                          ...
                                                          <div class="col-sm-2 " id="phone_code">
                            ...
                            <div class="col-sm-12 sidegap" style="padding: 0;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 sidegap">
                                                            ...
                                                            <div class="col-sm-3 sidegap">
                                                                <div class="form-group">
                                                                    <label class="calculation_labels"><span
                                                                        style="color: red;">*</span>
                                                                        <?php echo getLange('Chargable Weight'); ?></label>
                                                                        <input type="text" name="charweight" id="charweight"
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="calculation_labels"><span
                                                                        ...
                                                                        class="form-control" required="true" value="" placeholder="0.00">
                                                                    </div>
                                                                </div>
                                                                 <div class="col-sm-3 sidegap">
                                                                <div class="form-group">
                                                                ...
                                                                <div class="col-sm-2 sidegap" style="
                                                                display: none;">
                                                                    <label class="calculation_label"><span
                                ...
                                <div class="col-sm-2 sidegap">
                                    <div class="form-group"> <label
                                        ...
                                        <input type="text" name="delivery_charges" id="delivery_charges" class="form-control total_amount
                                    ...
                                    <div class="panel-body  invoice_note">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1 sidegap">
                                              ...
                                              <div class="col-sm-2 sidegap">
                                                <div class="form-group">
                                                    <label class="calculation_label">Dimensional wight</label>
