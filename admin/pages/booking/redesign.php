    ...
    <div id="basic-datatable_wrapper" class="dataTables_wrapper form-horizontal dt-bootstrap no-footer">
        <div class="row">
            ...
            <div class="col-sm-2 sidegap">
                ...
                <select class="form-control product_type_id" required="true" name="product_type_id" id="product_type_id">
        ...
        <div class="row">
                                ...
                                <div class="col-sm-2 sidegap">
                                    ...
                                    <div class="col-sm-2 sidegap">
                                        <div class="form-group">
                                            ...
                                            <input type="email"
                                            value="<?php //echo isset($customer_data['email']) ? $customer_data['email'] : '';  ?>notification.esire@gmail.com"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 sidegap" >
                                        ...
                                        <div class="col-sm-1 sidegap" >
                                            ...
                                            <div class="col-sm-5 sidegap" >
                                                    <div class="form-group">
                                                        <label
                                                        class="control-label"><?php echo getLange('pickupaddress'); ?>
                                                    </label>
                                                    <textarea style="    width: 100%;height: 33px;" autocomplete="false" class="form-control shipper_address"
                                                        ...
                                                        <div class="col-sm-2 sidegap" >
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label"><span style="color: red;"></span>
                                                                    ...
                                                                    placeholder="<?php echo getLange('consignee') . ' ' . getLange('email'); ?>" id="remail">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-1 sidegap" >
                                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5 sidegap ">
                                                    <div class="form-group">
                                                        <label> <span style="color: red;">*</span>
                                                            ...
                                                            <?php echo getLange('address'); ?> </label>
                                                            <textarea style="width: 100%;height: 33px;" placeholder="Receiver Address" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 sidegap">
                                                            <div class="form-group">
                                                                ...
                                                                Currency</label>
                                                                <input class="form-control" name="customer_currency" value="USD">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-2 sidegap">
                                                                <div class="form-group">
                                                                    <label class="calculation_label"><span
                                                                        ...
                                                                        class="form-control weight" required="true" value="1">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-2 sidegap">
                                                                ...
                                                                <div class="form-group">
                                                                    <label><span
                                                                        ...
                                                                        <textarea style="width: 100%;height: 33px;" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-sm-9 padding_10">
                            <div class="panel panel-default">
                                ...
                                <!-- <div class="panel-body booking_row"> -->
                                    <div class="panel-body  invoice_note">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1 sidegap">
                                                <div class="form-group add_more_row">
                            ...
                            <div class="col-sm-3 sidegap">
                                <div class="panel panel-default price_info" style="padding-bottom: 0;">
            ...
            <div class="save_print_btn" style="clear:both;padding: 0 0 0 6px;">
                ...
                <!-- <a href="#"
                class="submit_order btn btn-purple submit_btns btn-purple"><?php echo getLange('SAVE & DOWNLOAD'); ?></a> -->
            </div>
...
<script type="text/javascript">
    $('#product_type_id').on('change',function(){
        ...
        $.ajax({
                    url: '<?php echo BASE_URL ?>admin/ajaxcustomer.php',
                    type: 'POST',
                    data: {
                    id:product_type_id,cust_id:customer_id
                    },
                    success: function(response) {
                        if(response)
                        {
                            ...
                            var name = personObject['fname'];
                            var mobile_no = personObject['mobile_no'];
                            var email = personObject['email'];
                            $('#cname').val(name);
                            $('#rphone').val(mobile_no);
                            $('#remail').val(email);
                        }
                        else
                        {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (var i in service_types) {
                            var selected = '';
                            if(service_types[i].service_type=='International'){
                                selected='selected';
                            }
                            service_types_options += '<option '+selected+' value="' + service_types[i].id +
                            '">';
