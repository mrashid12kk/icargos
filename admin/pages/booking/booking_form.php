                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-6 padd_left" style="padding-right:0;">
                                                ...
                                                <div class="col-sm-6 " id="phone_code">
                                                    ...
                                                    <div class="phone_search"
                                                    style="position: absolute;right: 22px;top: 31px;">
                                                    <i class="fa fa-search search_phone"></i>
                                                </div>
                                            ...
                                            <?php if ($admin_other_charges == '1') : ?>
                                                <div class="col-sm-3">
                                                    <?php else : ?>
                                                        <div class="col-sm-6">
                                                        <?php endif; ?>
                                                        <div class="panel panel-default price_info" id="<?php echo isset($admin_other_charges) && $admin_other_charges == '1' ? 'price_info_small' : ''; ?>" style="padding-bottom: 103px;">
                    ...
                    <?php if ($admin_other_charges == '1') : ?>
                        <div class="col-sm-3" id="charges_table">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 padd_left" style="padding-right:0;">
                                        <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (var i in service_types) {
                            let checked = '';
                            if (service_types[i].is_favourite == 1) {
                                checked = 'Selected';
                            }
                            service_types_options += '<option ' + checked + ' value="' + service_types[i].id +
                            '">';
