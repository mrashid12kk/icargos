...
if(isset($_POST['submit'])){
    ...
    if (isset($_POST['submit_filter'])) {
        $from = isset($_POST['from_filter']) && $_POST['from_filter']!='' ? date('Y-m-d',strtotime($_POST['from_filter'])) : '';
        $to = isset($_POST['to_filter']) && $_POST['to_filter']!='' ? date('Y-m-d',strtotime($_POST['to_filter'])) : '';
        $customer_id= isset($_POST['customer_filter']) && $_POST['customer_filter'] ? $_POST['customer_filter'] : '';
    }
?>
<?php
            ...
            <div class="row">
                ...
                <div class="col-sm-12 table-responsive gap-none">
                              ...
                              <div class="col-sm-2 left_right_none">
                                <div class="form-group">
                                        ...
                                        <select class="form-control origin js-example-basic-single" name="origin" id="origin">
                                            ...
                                            <option <?php if($row['city_name'] == $default_city){ echo "selected"; } ?>  <?php if($active_origin == $row['city_name']){ echo "selected"; } ?>><?php echo $row['city_name']; ?></option>
                                        <?php } ?>
                                        </select>
                                    </div>
                              </div>
                    ...
                    <table id="order_datatable" cellpadding="0" cellspacing="0" border="0" class="table table-striped orders_tbl  table-bordered no-footer dtr-inline collapsed" role="grid" aria-describedby="basic-datatable_info">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="5" style="background-color: #DEDEDE;"><?php echo getLange('total'); ?></th>
                                <th class="noofpiece" style="background-color: #b6dde8;"></th>
                                <th class="parcelweight" style="background-color: #c2d69a;"></th>
                                <th class="fragile" style="background-color: #b6dde8;"></th>
                                <th class="insureditemdeclare" style="background-color: #c2d69a;"></th>
                                <th class="codamount" style="background-color: #b6dde8;"></th>
                                <th class="deliveryfee" style="background-color: #c2d69a;"></th>
                                <th class="specialcharges" style="background-color: #b6dde8;"></th>
                                <th class="extra_charges" style="background-color: #c2d69a;"></th>
                                <th class="insurancepremium" style="background-color: #b6dde8;"></th>
                                <th class="grand_total_charges"style="background-color: #c2d69a;"></th>
                                <th class="fuelsurcharge" style="background-color: #b6dde8;"></th>
                                <th class="salestax" style="background-color: #c2d69a;"></th>
                                <th class="netamount" style="background-color: #b6dde8;"></th>
                                <th colspan="2" style="background-color: #c2d69a;"></th>
                            </tr>
                        </tfoot>
                    </table>
