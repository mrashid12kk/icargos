 ...
 if(isset($_GET['delete_id']))
    {
        ...
        mysqli_query($con,"DELETE FROM route WHERE id=".$ex." ");
         $_SESSION['msg'] = '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong></strong> Route Deleted Sucessfully.</div>';
         header('Location: route_list.php');
    } 
    ?>
<div class="col-sm-12 outer_shadow table_template" >
   <div class="top_heading">
      <h3 class="ng-binding">Route List</h3>
      <a href="add_country.php" class="btn btn-info" style="margin-top: -60px;margin-left: 785px;">Add New</a>
   </div>
   <?php if (isset($_SESSION['msg']) && !empty($_SESSION['msg'])) {
      ...
      <br>
      <table class="table table-striped table-bordered  no-footer dtr-inline" id="country_table">  
        <div class="fake_loader" id="image" style="text-align: center;">
         ...
         <thead>
            <th>srno</th>
            <th>Country Name</th>
            <?php if (isset($_GET['country_id']) || isset($_GET['state_id']) || isset($_GET['city_id'])) { ?><th>State Name</th> <?php }?>
            <?php if (isset($_GET['state_id']) || isset($_GET['city_id'])) { ?><th>city Name</th> <?php }?>
           <?php if (isset($_GET['city_id'])) { ?><th>Route Code</th><th>Route</th><th>Action</th> <?php }?>
         </thead>
