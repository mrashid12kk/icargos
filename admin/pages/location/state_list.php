 ...
 if(isset($_GET['delete_id']))
    {
        ...
        mysqli_query($con,"DELETE FROM state WHERE id=".$ex." ");
         $_SESSION['msg'] = '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong></strong> State Deleted Sucessfully.</div>';
...
<div class="col-sm-12 outer_shadow table_template" >
   <div class="top_heading">
      ...
      <a href="add_state.php" class="btn btn-info" style="margin-top: -60px;margin-left: 785px;">Add New</a>
   </div>
   <?php if (isset($_SESSION['msg']) && !empty($_SESSION['msg'])) {
      ...
      <form>
         <div class="row">
            <div class="col-sm-9">
               <input type="text" class="form-control" id="country_name" placeholder="Enter For Searching">
            </div>
