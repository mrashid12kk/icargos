...
$status_query=mysqli_query($con,"Select * from order_status where sts_id = 7 AND  active='1'");
...
if(isset($_POST['submit']))
{
		if(isset($_POST['tracking_no']) && !empty($_POST['tracking_no'])){
			$filter_query .= " AND order_num = '".$_POST['tracking_no']."' ";
		...
		$query1 = mysqli_query($con,"SELECT * FROM assignment_record WHERE DATE_FORMAT(`assign_data_time`, '%Y-%m-%d') >= '".$from."' AND  DATE_FORMAT(`assign_data_time`, '%Y-%m-%d') <= '".$to."' AND rider_status_done_no = '0' AND  user_id =".$rider_id." AND assignment_type=2    $filter_query order by id desc ");
	...
	// print_r($_SESSION);
	// die();
	// echo "SELECT * FROM assignment_record WHERE DATE_FORMAT(`assign_data_time`, '%Y-%m-%d') >= '".$from."' AND  DATE_FORMAT(`assign_data_time`, '%Y-%m-%d') <= '".$to."'  AND rider_status_done_no = '0' AND user_id =".$rider_id." AND assignment_type=2  $filter_query  order by id desc ";
	// die();
}
...
function getBranchName($id)
{
    ...
    global $con;
    $query = "SELECT name from branches where id = $id";
    $fethc = mysqli_query($con,$query);
    $res = mysqli_fetch_array($fethc);
	...
	<div class="panel-heading">Orders</div>
		...
		<div class="panel-body" id="same_form_layout">
			...
			<div id="basic-datatable_wrapper" class="dataTables_wrapper form-horizontal dt-bootstrap no-footer">
						...
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable no-footer" id="basic-datatable" role="grid" aria-describedby="basic-datatable_info">
							...
							?>
								<tr class="gradeA odd" role="row">
									...
									<!-- <td ><?php echo getBranchName($row_data['branch_id']); ?></td> -->
									<!-- <td ><?php echo getBranchName($row_data['assign_branch']); ?></td> -->
				...
				<td>
					<span class="badge badge-pill badge-primary" style="background: #39bcb5;"><?php echo $fetch1['status']; ?></span>
				</td>
