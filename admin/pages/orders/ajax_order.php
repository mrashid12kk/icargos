...
// die;
  ...
  if (isset($_GET['delayed']) && !empty($_GET['delayed'])) {
    $delayed='delayed';
    $date_type=$_GET['delayed'];
  }
?>
<?php
                            ...
                            <div class="row" >
                                ...
                                <div class="col-sm-2 left_right_none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="<?php echo getLange('pickupname'); ?>" value="<?php echo $active_customer_name; ?>" class="form-control " name="customer_name" id="customer_name">
                                    </div>
                                    <div class="field_svg">
                                ...
                                <div class="col-sm-2 left_right_none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="<?php echo getLange('pickupphone'); ?>" value="<?php echo $active_customer_phone; ?>" class="form-control " name="customer_phone" id="customer_phone">
                                        <div class="field_svg">
                                ...
                                <div class="col-sm-2 left_right_none" >
                                    <div class="form-group">
                                        ...
                                        <select class="form-control courier_list js-example-basic-single" name="origin_city"  id="origin_city">
                                            <option value=""><?php echo getLange('all').' '.getLange('city'); ?></option>
                                            <?php while($row=mysqli_fetch_array($city_query)){ ?>
                                            <option  <?php // echo isset($row['city_name']) && $row['city_name'] == $city_default['value'] ?'selected':''; ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-2 left_right_none" >
                                    <div class="form-group">
                                        ...
                                        <select class="form-control courier_list js-example-basic-single" name="order_city"  id="order_city">
                                            ...
                                            <option  <?php // if($row['city_name'] == $city_default['value'] ){ echo "selected"; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-sm-2 left_right_none">
                                    <div class="form-group">
                                        <label>Delayed Order </label>
                                        <select class="form-control" name="" id="delayed">
                                            <option value="all" selected>All</option>
                                            <option value="delayed" <?php if (isset($delayed) && $delayed=='delayed') {echo 'selected';} ?>>Delayed</option>
                                        </select>
                                ...
                                <div class="col-sm-2 sidegapp-submit " style="margin: 0;">
                                  ...
                                  <div class="col-sm-4 left_right_none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="<?php echo getLange('enter').' '.getLange('Multiple').' '.getLange('CN'); ?>" value="<?php echo $active_tracking; ?>" class="form-control " name="tracking_no_bulk" id="tracking_no_bulk">
                                        <div class="field_svg">
                                         <!--  <svg viewBox="0 0 24 24"><path d="M11.5 7a2.5 2.5 0 1 1 0 5a2.5 2.5 0 0 1 0-5zm0 1a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3zm-4.7 4.357l4.7 7.73l4.7-7.73a5.5 5.5 0 1 0-9.4 0zm10.254.52L11.5 22.012l-5.554-9.135a6.5 6.5 0 1 1 11.11 0h-.002z" fill="#626262"/></svg> -->
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-2 sidegapp-submit " style="margin: 0;">
                                    <input type="button"  id="submit_order_bulk" name="submit_bulk" class="btn btn-success search_filter1" value="<?php echo getLange('bulk').' '.getLange('search'); ?>">
                                  </div>
