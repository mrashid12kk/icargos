...
$voucher_type_query = "SELECT * FROM `tbl_vouchertype` WHERE voucherTypeName = 'Receipt Voucher'";
...
$dn_query = "SELECT * FROM `tbl_reciept_voucher_detail` ORDER BY id DESC LIMIT 1";
...
if(isset($_GET['voucher_no']))
{
	...
	$edit_query_debit_master = "SELECT pv_master.id as masterId,pv_master.description,pv_master.cheque_date,ledg.ledgerName,ledg.id as masterLedgerId FROM `tbl_reciept_voucher_master` as pv_master LEFT JOIN tbl_accountledger as ledg ON pv_master.cash_bank_ledger_id = ledg.id  WHERE voucher_no = '{$voucher_no}'";
...
<div class="warper" id="transactions">
	<div class="panel panel-default">
		<div class="panel-heading">Receipt Voucher</div>
		<?php
				...
				<div class="col-sm-4 sidegap">
					<div class="row">
						...
						<div class="col-sm-4 searhbox">
							<button type="button" class="btn btn-primary" id="debit-search-btn" data-table="tbl_reciept_voucher_detail" data-mastertable="tbl_reciept_voucher_master" data-prtype="no">Search</button>
						</div>
					</div>
            ...
            <div class="row remarks_box">
            	...
            	<div class="col-sm-6 sidegap">
            		<div class="input-right-box">
						...
						<button type="submit" name="reciept_voucher_save" class="btn btn-info" id="debit_save">Save</button>
						<button type="submit" name="reciept_voucher_save_print" value="save_print" class="btn btn-info">Save &amp; Print</button>
