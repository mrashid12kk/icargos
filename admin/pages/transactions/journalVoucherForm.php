...
$voucher_type_query = "SELECT * FROM `tbl_vouchertype` WHERE voucherTypeName = 'Journal Voucher'";
...
$dn_query = "SELECT * FROM `tbl_journal_voucher_detail` ORDER BY id DESC LIMIT 1";
...
if(isset($_GET['voucher_no']))
{
	...
	$edit_query_credit_master = "SELECT * FROM `tbl_journal_voucher_master` WHERE voucher_no = '{$voucher_no}'";
				...
				<div class="col-sm-4 sidegap">
					<div class="row">
						...
						<div class="col-sm-4 searhbox">
							<button type="button" class="btn btn-primary" id="debit-search-btn" data-table="tbl_journal_voucher_detail" data-mastertable="tbl_journal_voucher_master">Search</button>
						</div>
					</div>
            ...
            <div class="row remarks_box">
            	...
            	<div class="col-sm-6 sidegap">
            		<div class="input-right-box">
						...
						<button type="submit" name="journal_voucher_save" class="btn btn-info" id="debit_save">Save</button>
						<button type="submit" name="journal_voucher_save_print" value="save_print" class="btn btn-info">Save &amp; Print</button>
