        ...
        <section class="content">
            ...
            <div class="warper container-fluid">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Manual Api Booking</div>
            ...
            <div class="download_bx">
                <div class="upload_btn">
                    <a class="btn btn-danger" href="assets/excel/api_manual_booking.xlsx" download="">Download Sample Sheet</a>
                </div>
            </div>
            <form action="" method="post">
...
<script>
    $(document).ready(function() {
        ...
        $("#submit").click(function() {
            ...
            $.ajax({
                url: 'ajax_import_manual_api.php',
                dataType:'Json',
                beforeSend: function() {
                    $('#image1').show();
                }, 
