    ...
    <section class="content">
        ...
        <div class="warper container-fluid">
                    ...
                    <div class="warper container-fluid">
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="panel panel-primary">
                                <div class="panel-heading"><?php echo isset($edit['id']) ? 'Update' : 'Add'; ?> Pincode
                                </div>
                                            ...
                                            <form method="post" action="" enctype="multipart/form-data">
                                                <div class="col-sm-12 template_form side_gapp">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 form_box">
                                                            <label>Pincode</label>
                                                            <input type="text" class="" name="pincode"
                                                                autocomplete="off"
                                                                value="<?php echo isset($edit['pincode']) ? $edit['pincode'] : ''; ?>"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
            ...
            <!--  <?php
                        ...
                        // include "pages/location/add_pincode.php";
