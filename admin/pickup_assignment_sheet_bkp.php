...
<table class="table">
  ...
  $queries = mysqli_query($con,"SELECT barcode_image, track_no,sname,sbname,sender_address,Pick_location,sphone,destination,weight,quantity,collection_amount FROM orders WHERE customer_id='".$business_id."' AND assignment_no='".$assignment_no."'  ");
...
$total_pieces = 0;
  ...
  <tr>
    ...
    <td>
      <?php echo isset($single_order['Pick_location']) && $single_order['Pick_location']!='' ? $single_order['Pick_location'] : $single_order['sender_address']; ?></td>
     <td>
