    ...
    <body data-ng-app>
        ...
        <section class="content">
            ...
            <div class="warper container-fluid">
                ...
                include "pages/booking/redesign.php";
...
$('body').on('click', '.btn_commercial_invoice', function(e) {
    ...
    e.preventDefault();
    var html =
    "<div class='row'><div class='col-sm-5 sidegap'><div class='form-group'><label class='calculation_label'>Discription</label><input type='text' class='form-control' name='c_i_discription[" +
    array_value +
    ...
    array_value +
    "]' value='0' class='form-control c_i_hs_total'></div></div><div class='col-sm-1 sidegap'><div class='form-group add_more_row '><a href='' class='btn btn-danger btn_commercial_invoice_romove' >-</a></div></div></div></div>";
