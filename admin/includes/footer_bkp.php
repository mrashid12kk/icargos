...
if (isset($limit_enable) && $limit_enable == 1 && isset($checkArray) && ($checkArray['orders_count']) >= $checkArray['limit_message']) : ?>
    ...
    <script src="<?php echo BASE_URL?>admin/assets/js/app/jquery-2.2.4.min.js"></script>
    <script src="<?php echo BASE_URL?>admin/assets/js/app/custom.js" type="text/javascript"></script>
    ...
    <script src="<?php echo BASE_URL?>admin/assets/js/bootstrap/bootstrap.min.js"></script>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src='https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js'></script>

    <script type="text/javascript" src="<?php echo BASE_URL?>admin/assets/js/jquery.inputmask.js" charset="utf-8"></script>
    <script type="text/javascript">
        $("#phone").inputmask({
            "mask": "999-999-999-99"
        });
    </script>
    <script src="<?php echo BASE_URL?>admin/assets/js/plugins/bootstrap-validator/bootstrapValidator.min.js"></script>
    <script src="<?php echo BASE_URL?>admin/assets/js/datatables.min.js"></script>

    <script src="<?php echo BASE_URL?>admin/assets/js/moment/moment.js"></script>
    <script src="<?php echo BASE_URL?>admin/assets/css/demo.js"></script>

    <script src="<?php echo BASE_URL?>admin/assets/js/select2.js"></script>
<!-- 
    ...
    <script src="<?php echo BASE_URL?>admin/assets/js/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
