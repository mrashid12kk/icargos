...
// die();
 ?>
            ...
            <div class="warper container-fluid">
                <div class="alert alert-success display_none"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> You Added Manifest Details successfully</div>
                ...
                <div class="manifest_box">
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6 colums_gapp">
                                    <div class="colums_content">
                                        ...
                                        <input type="text" value="<?php echo $number+ 1; ?>" name="manifest_no" class="manifest_no" readonly="">
                                    </div>
                                </div>
                                <div class="col-sm-6 colums_gapp">
                                    <div class="colums_content">
                                        <label><?php echo getLange('date'); ?></label>
                                        <input type="date" placeholder="" value="<?php echo date('Y-m-d'); ?>" name="date" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <div class="col-sm-12 colums_gapp">
                                                <?php while ($row= mysqli_fetch_assoc($type_query)) {?>
                                                    <?php $checked = '';
                                                     ...
                                                     ?>
                                                    <label> <input class="with_auto" type="radio" <?php echo $checked; ?> value="<?php echo $row['id']; ?>" name="type" > <?php echo $row['name']; ?></label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 colums_gapp">
                                    <div class="colums_content">
                                        ...
                                        <input type="text" placeholder="16407" name="bilty_no" >
                                    </div>
                                </div>
                                <div class="col-sm-6 colums_gapp">
                                    <div class="colums_content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 colums_gapp">
                                    <div class="colums_content">
                                        ...
                                        <input type="text" placeholder="SLT-2012" name="truck_no">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-8 colums_gapp">
                                    <div class="colums_content">
                                        ...
                                        <?php if (isset($_SESSION['branch_id']) && !empty($_SESSION['branch_id'])): ?>
                                            <select class="js-example-basic-single sending_branch_val" name="sending_branch">

                                            <option value="<?php echo $_SESSION['branch_id']; ?>"><?php echo $current_branch; ?></option>

                                        </select>
                                        <?php else: ?>
                                        <select class=" sending_branch_val" name="sending_branch">
                        ...
                        <div class="col-sm-5  gray-bg colums_gapp" style="padding-right: 8px;">
                    ...
                    <div class="row">
                        <div class="col-sm-9 colums_gapp">
                            <div class="colums_content">
                                ...
                                <textarea type="text" class="remarks" name="remarks" style="margin: 0px 53.3281px 0px 0px;height: 50px;width: 100%;display: block;"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="row">
                                ...
                                <div class="col-sm-12 colums_gapp">
                                    <div class="colums_content skip-bag">
                                        <label><?php echo getLange('orderupdatestatus'); ?>   (*)</label>
                                         <?php if ($_SESSION['user_role_id']==getfranchisemanagerId()){ 
                                        echo " <input type='text' name='status' value='In Transit to Branch' readonly>";}else{ ?>
