...
if(isset($_SESSION['users_id']) &&($_SESSION['type']!=='driver')){
  ...
  <body data-ng-app>
    ...
    <section class="content">
      ...
      <div class="warper container-fluid">
        ...
        <?php
         ...
         include "pages/reports/account_ledger_detail_report.php";
    ...
    'ajax': {
     'url':'ajax_view_account_ledger_detail_report.php',
     beforeSend: function(){
      $('#image').show();
    },
    complete: function(){
    ...
    'data': function(data){
      ...
      { data: 'closingblnc' },
        ...
        $('#submit_order').click(function(e){
          ...
          {
            window.location.href = "account_ledger_reports.php?acc_grp_id="+$("#acc_group_name option:selected").val()+"&voucher_type_id="+$("#voucher_type option:selected").val()+"&date_range="+$("#date_range option:selected").val()+"&from="+$('#from').val()+"&to="+$('#to').val();
          }
