...
// die;
$origin = isset($decoded['origin']) ? strtoupper($decoded['origin']) : '';
$origin = trim($origin);
...
$order_id = isset($decoded['order_id']) ? $decoded['order_id'] :'';
...
$insert_qry = 'INSERT INTO `orders`(`sname`,`sbname`,`sphone`, `semail`, `sender_address`, `rname`, `rphone`,`remail`, `receiver_address`,`price`,`collection_amount`,`order_date`,`order_time`,`customer_id`,`origin`,`destination`,`weight`,`product_desc`,`special_instruction`,`quantity`,`product_id`, `order_type`,`pft_amount`,`inc_amount`,`Pick_location`,`pickup_time`,`pickup_latitude`,`pickup_longitude`,`Cust_ref`,`is_fragile`,`order_type_booking`,`net_amount`,`grand_total_charges`,`current_branch`,`booking_branch`,`product_type_id`,`fuel_surcharge`,`fuel_surcharge_percentage`) VALUES ("' . $fname . '","' . $bname . '","' . $mobile_no . '","' . $email . '","' . $address . '","' . $receiver_name . '","' . $receiver_phone . '","' . $receiver_email . '","' . $receiver_address . '","' . (int)$price . '","' . $collection_amount . '","' . $date . '","' . $date . '","' . $customer_id . '","' . $origin . '","' . $destination . '","' . $weight . '","' . $product_description . '","' . $special_instruction . '","' . $pieces . '","' . $order_id . '","' . $order_type . '","' . $pft_amount . '","' . $incl_amount . '","' . $pickup_location . '","' . $pick_time . '","' . $customer_latitude . '","' . $customer_longitude . '","' . $Cust_ref . '","' . $is_fragile . '",1 ,"' . $net_amount . '","' . $total_charges . '",1,1,"' . $product_type_id . '","' . $fsc_amount . '","' . $fsc . '")';
 // echo $insert_qry;
