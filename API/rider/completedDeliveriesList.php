...
$pickQ = "SELECT assignment_record.order_num as track_no, orders.order_type, orders.collection_amount, orders.status,  orders.rname as receiver_name,   orders.receiver_address, orders.rphone as receiver_phone  from assignment_record join orders on assignment_record.order_num = orders.track_no WHERE assignment_record.rider_status_done_no = '1' AND assignment_record.assignment_type=2  AND  assignment_record.user_id =" . $rider_id . "   order by assignment_record.id desc ";
