...
@media(max-width: 767px){
	...
	.progressbar h3 ,.complete_profile {
	    text-align: center;
	}
	.complete_profile a {
	    margin-left: 3px;
...
@media(max-width: 1250px){
    ...
    #header_wrap .theme-menu > li:nth-child(5), #header_wrap .theme-menu > li:nth-child(6) {
...
<input type="hidden" id="customer_id" value="<?php echo $_SESSION['customers']; ?>">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        ...
                        <div class="progress">
                          <div class="progress-bar progress-bar-warning progress-bar-striped" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                           <span><p style="display: inline;" class="upload_processing">0 </p>% Complete </span>
                          </div>
                        </div>
                        <button style="display: inline;" class="validation btn btn-info">Check Validation</button>
                        <div>Validation</div>
                        <div class="progress" id="progressbar">
                          ...
                          <div class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="progressbar_validation">
                            <span><p class="validation_process" style="display: inline;">0 </p>% Complete </span>
                          </div>
                        </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                      ...
                      <div class="progress">
                        <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="0" aria-valuemin="100" aria-valuemax="100" style="width: 0%" id="progressbar_submit">
                         <span><p style="display: inline;" class="submit_process">0 </p>% Complete </span>
                        </div>
                      </div>
                         
                        <ul class="list-inline pull-right">
                            <li><button type="button" class="btn btn-default prev-step"><?php echo getLange('previous'); ?></button></li>
                            <li><button type="button" class="btn btn-primary"  onclick="Loading.show()"  id="submit_step_data"><?php echo getLange('submit'); ?></button></li>
                        </ul>
                    </div>
  ...
  .whitee:hover{
	...
	.jexcel_container,.jexcel_content,.jexcel{
		width: 100% !important;
	}
  </style>
</section>
...
<script>
    $(document).ready(function () {
        ...
        if(remanefile!=""){
            $.ajax({
                type:'POST',
                data:{remane:1,remanefile:remanefile,oldfile:oldfile},
                url:'ajax_bulk_import.php',
                success:function(fetch){
                	if(fetch==19){
                		var fatch_msg='This File Is Alredy Exist Please Chose Another File Name';
  ...
  $('body').on('click', '.validation', function(e) {
      ...
      $.ajax({
        ...
        //         },
                ...
                // },
        type: 'POST',
        data: {bulk_booking:1,change_file_name:change_file_name,customer_id:customer_id},
        dataType: 'json',
    ...
    $('body').on('click', '#submit_step_data', function(e) {
      ...
      $.ajax({
        ...
        type: 'POST',
        data: {save_booking:1,change_file_name:change_file_name,customer_id:customer_id},
        dataType: 'json',
        success: function(response) {
          if (response.error) {
          	$('.bulk_msg').html(response.alert_msg);
