                                            ...
                                            <div class="col-sm-6 padd_left">
                                                <div class="form-group">
                                                    <label><span style="color: red;">*</span>
                                                        ...
                                                        <select class="form-control js-example-basic-single origin" name="origin">
                                                            <?php while ($row = mysqli_fetch_array($origin_q)) { ?>
                                                                <option <?php if ($row['city_name'] == $customer_data['city']) {
                                                                    echo "selected";
                                                                } ?>>
                                                    ...
                                                    <select class="form-control select_profile js-example-basic-single" name="profile_id">
                                                                ...
                                                                <div class="col-sm-3 padd_left padd_right">
                                                                    <div class="form-group">
                                                                        <label class="calculation_label"><span
                                                                            ...
                                                                            <input type="myNumber" name="weight" class="form-control weight"
                                                                            required="true" value="0.5">
                                                                        </div>
                                                                    </div>
