...
if(isset($_SESSION['customers'])){
    ...
    <style>
        ...
        .main_fix_tree {
            background: linear-gradient(45deg, #234277, #254985);
            padding: 20px;
            border-radius: 10px;
    ...
    <section class="bg padding30">
        <div class="container-fluid dashboard">
            ...
            <div class="col-lg-10 col-md-9 col-sm-8 dashboard" id="dashboard_page">
                ...
                <div class="white">
                    <div class="row">
                        ...
                        <div class="col-sm-2 text-right">
                            ...
                            $totacount=mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(id) as total_unread FROM `order_comments` WHERE customer_read=0 AND customer_id=".$id."")); ?>
                            <a href="comments_report.php"><button class="btn btn-primary">Comments(<?php echo $totacount['total_unread']; ?>)</button></a>

                        </div>
                    </div>
                    <form method="POST" action="">
                        <div class="row input_datapicker">
                            <div class="col-sm-1 left_right_none from_to">
                                <div class="form-group">
                                    <label><?php echo getLange('from'); ?></label>
                                    <input type="text" value="<?php echo $from_date; ?>" class="form-control datepicker"
                                    name="from">
                                </div>
                            </div>
                            <div class="col-sm-1 left_right_none from_to">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $to_date; ?>" class="form-control datepicker"
                                    name="to">
                                </div>
                            </div>
                            <div class="col-sm-1 sidegapp-submit search_dashboard_Btn date_tosearch">
  ...
  // }
   ...
   // echo $collectedPayments;
                            ...
                            while($single = mysqli_fetch_array($main_query)){
                                ...
                                ?>
                                <div class="col-sm-2 profile-page-title colum_width">
                                    <div style="background: <?php echo $color_code; ?>"
                                        class="mini-stat clearfix bx-shadow bg-info dash-item"> <span class="mini-stat-icon"><i
                                            style="background: <?php echo $color_code; ?>" class="fa fa-cube fa-6"></i></span>
                                            <div class="mini-stat-info text-right"><a class="whitee"
                                                href="order.php?orderss_status=<?php echo $single['status']; ?>">
                                                <p><?php echo getKeyWordCustomer($id,$single['status']); ?></p> <span
                                                class=""><?php echo $total_orders; ?></span>
                                            </a> </div>
                                        </div>
                                        <div class="line_chart">
                                            <img src="img/dark-blue-threee.png">
                                        </div>
                                    </div>
                                <?php } ?>

                                <div class="col-sm-2 profile-page-title colum_width">
                                    <div class="mini-stat clearfix bx-shadow bg-info6 dash-item"> <span class="mini-stat-icon"><i
                                        style="background:#7fa9f6;" class="fa fa-cube fa-6"></i></span>
                                        <div class="mini-stat-info text-right"> <a class="whitee" href="tracking.php">
                                            <p> <?php echo getLange('trackorder'); ?></p> <span class=" whitee"></span>
                                        </a> </div>
                                    </div>
                                    <div class="line_chart">
                                        <img src="img/dark-blue-threee.png">
                                ...
                                <div class="col-sm-2 profile-page-title colum_width">
                                    <div class="mini-stat clearfix bx-shadow bg-info7 dash-item"> <span class="mini-stat-icon"><i
                                        style="background: #83a1d3;" class="fa fa-cube fa-6"></i></span>
                                        <div class="mini-stat-info text-right"> <a class="whitee" href="orders.php">
                                            <p><?php echo getLange('vieworder') ?></p> <span
                                            class=" whitee"><?php echo $totalorder; ?></span>
                                        </a> </div>
                                    </div>
                                    <div class="line_chart">
                                        <img src="img/dark-blue-threee.png">
                                ...
                                <div class="col-sm-2 profile-page-title colum_width">
                                    <div class="mini-stat clearfix bx-shadow bg-info dash-item"> <span class="mini-stat-icon"><i
                                        style="background: #a2bcec;" class="fa fa-cube fa-6"></i></span>
                                        <div class="mini-stat-info text-right"><a class="whitee" href="orders.php">
                                            <p><?php echo getLange('pending').' '.getLange('codamount'); ?></p> <span
                                            class=""><?php echo $totalcod; ?></span>
                                        </a></div>
                                    </div>
                                    <div class="line_chart">
                                        <img src="img/dark-blue-threee.png">
                                        ...
                                        if (isset($_SESSION['customer_type']) && $_SESSION['customer_type']==1) { ?>
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <?php echo  isset($_SESSION['customer_type']) && $_SESSION['customer_type']==2 ? ' Invoice Payable'  : getLange('cod_receivable');?>
                                                </div>
                                                <div class="panel-body">

                                                    <div class="row charts padd_left_p"
                                                    style="background:#fff;border: 1px solid #ccccccab;padding-bottom: 12px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 final_first_c pr-0">
                                                            <div class="main_fix_tree bottom_left new_color right_center"
                                                            style="background:linear-gradient(45deg, #7a00ff, #3f0282);">
                                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 last_total main_fix_tree new_color"
                                                            style="background:linear-gradient(45deg, #7a00ff, #3f0282);">
                                                ...
                                                <div class="col-lg-6 final_first_c ">
                                                    <div class="main_fix_tree bottom_left new_color_last"
                                                    style="background:linear-gradient(310deg, #3456fb, #a12eae);">
                                                    <div class="row">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-12">
            ...
            while($single2 = mysqli_fetch_array($main_querys))
            {
                ...
                ?>
                <input type="hidden"
                name="<?php echo getKeyWordCustomer($id,$single2['status']) ?>"
                value="<?php echo $can; ?>" />
            <?php } ?>
